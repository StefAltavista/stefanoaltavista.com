    ...
    <div id="footer">
      <div id="footer_contact" className="footer_section">
        ...
        <div id="footer_disclaimer" className="footer_section">
          ...
          >
            *This website does not use cookies, web beacons, or other tracking
            technologies. <br></br>
            <br></br>Built with: Next.js - Node.js - PostgreSQL - Prisma -
            P5.js- GSAP
            <br></br>
          ...
          >
            © Copiright 2022 stefanoaltavista.com <br></br>All Rights Reserved.
          </p>
        </div>
      </div>
      {pathName != "/contact" && (
